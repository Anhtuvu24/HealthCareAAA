...
// Hiển thị xuất hóa đơn
document.getElementById('issue-invoice').addEventListener('change', function() {
    var inforInvoice = document.querySelector('.infor-invoice');
    if (this.checked) {
        inforInvoice.style.display = 'flex';
    } else {
        inforInvoice.style.display = 'none';
    }
});
console.log(document.getElementById('issue-invoice'))

// Đảm bảo trạng thái ban đầu của .infor-invoice
document.getElementById('issue-invoice').dispatchEvent(new Event('change'));
